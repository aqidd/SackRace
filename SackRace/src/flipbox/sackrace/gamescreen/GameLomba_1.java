 ...
 */
public class GameLomba_1 implements IGameScene {
    ...
    public void initResource() throws IOException {
        ...
        storyDialog = new ImageItem("/resource/tambahan/Dialog 3_2.jpg").setX(0).setY(0).setVisible(true);
...
//                        System.out.println(player.getSprite().getFrame());
    ...
    public void pointerReleased(int x, int y) {
        ...
        if (finish != TypeList.PLAYING) {
            try {
                if (finish == TypeList.SUCCESS) {
                    if (GameDataHelper.getHighScore(GameDataHelper.BALAP_KARUNG_LOMBA_1) < player.getCoinCount()) {
                        GameDataHelper.writeHighScore(GameDataHelper.BALAP_KARUNG_LOMBA_2, player.getCoinCount());
                    }
                ...
                releaseMemory();
                GameMidlet.gameCanvas.setGameScene(new GameLomba_2());
    ...
    private void initLevel() {
        LevelGenerator.initConstraints(14, 17, 3, 4, 2, 3, 50, 65, speed);
        LevelGenerator.initDistance(50, 300, 100, 200);
        LevelGenerator.initObjective(TypeList.DISTANCE, 2750);
    ...
    private void initBackground() throws IOException {
        backgroundImage = new ImageItem("/resource/lomba/Sack Runner-05.jpg");
        backgroundImage2 = new ImageItem("/resource/lomba/Sack Runner-02.jpg");
    ...
    private void renderBackground(int fpr, Graphics g) {
        ...
        g.drawImage(backgroundImage2.getImage(), 0, BACKGROUND_POSB, Graphics.LEFT | Graphics.TOP);
        g.drawImage(backgroundImage2.getImage(), 0, BACKGROUND_POSC, Graphics.LEFT | Graphics.TOP);
    ...
    private void renderScore(Graphics g) throws Exception {
        ...
        grImageHigh.drawString("HIGHSCORE :" + GameDataHelper.getHighScore(GameDataHelper.BALAP_KARUNG_LOMBA_1), 0, 0, Graphics.LEFT | Graphics.TOP);
